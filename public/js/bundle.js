    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "You logged out!");
            window.setTimeout(function () {
              location.assign("/");
            }, 1000);
          }
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === "success") (0, _alerts.showAlert)("success", "".concat(type.toUpperCase(), " update successfully!"));
          _context.next = 11;
          break;
        case 8:
          _context.prev = 8;
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // // //
var stripe = Stripe("pk_test_51QoXhZG632GANj1HwbXC9GqsRVdncy8upgLLLO7C3ylcLyh33W0cWQktlLK4zrUaV2PEghJCW6mJMpybApqtdBeS008wTcQC5G");
...
if (userDataForm) userDataForm.addEventListener("submit", function (event) {
  event.preventDefault();
  var form = new FormData(); // ⏺ FormData() is a JavaScript object used to collect form data and send it, including files in HTTP requests
